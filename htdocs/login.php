...
<head>
    ...
    <title>Login | UNSERA Dashboard</title>
...
<div class="login-card">
    <div class="logo-area">
        ...
        <p style="color: #64748b; font-size: 0.85rem; font-weight: 500; letter-spacing: 1px;">SISTEM INFORMASI DATA UNIVERSITAS</p>
    </div>
    ...
    <form method="POST">
        ...
        <button type="submit" name="login" class="btn btn-primary" style="width: 100%; padding: 15px; font-size: 1rem; font-weight: 700; border-radius: 12px; background: linear-gradient(135deg, #0ea5e9, #6366f1); border: none;">
            MASUK SEKARANG
        </button>
    </form>

    <div style="margin-top: 35px; text-align: center; color: #64748b; font-size: 0.9rem;">
        Belum memiliki akses? <a href="register.php" style="color: #38bdf8; text-decoration: none; font-weight: 700; border-bottom: 2px solid rgba(56, 189, 248, 0.2);">Daftar Baru</a>
    </div>
</div>
